...
export default function Register() {
  ...
  const [confirmPassworddError, setConfirmPassword] = useState("");
    const [isDisablle, setIsDisable] = useState(false);
    console.log("isDisablle",isDisablle );
    ...
    switch (nameInput) {
      ...
      case "password":
        if (!valueInput) {
          ...
          setPasswordError("Mật khẩu không được ngắn hơn 6 ký tự.");
        } else {
          setPasswordError("");
        }
      ...
      case "confirmPassword":
        if (!valueInput) {
          ...
          setConfirmPassword("Mật khẩu không trùng khớp");
          return;
        } else {
          setConfirmPassword("");
        }
        ...
        <form className="form-login" onSubmit={handleSubmit}>
          ...
          <div className="form-group mb-3">
            ...
            <input
              ...
              onChange={handleInputChange}
            />
            {confirmPassworddError && (
              <div className="text-err mt-1">{confirmPassworddError}</div>
            )}
          </div>
